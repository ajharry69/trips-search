...
public class TripData {
    public static Trip TRIP = new Trip.Builder(1L)
            ...
            .setDriverRating(5)
            .setDriverPic("https://hr.hava.bz/trips/p13.jpg")
            .setCarMake("Honda")
            .setCarModel("Civic")
            .setCarNumber("KCR-100P")
            .setCarYear(2012)
            .setCarPic("https://hr.hava.bz/trips/c13.jpg")
            .setDuration(36)
            .setDurationUnit("min")
            .setDistance(1.45f)
            .setDistanceUnit("km")
    ...
    public static List<Trip> remoteTrips() {
        ...
        trips.add(new Trip.Builder(2L)
                ...
                .setDriverRating(0)
                .setDriverPic("https://hr.hava.bz/trips/p9.jpg")
                .setCarMake("Nissan")
                .setCarModel("March")
                .setCarNumber("KCQ-6711")
                .setCarYear(2015)
                .setCarPic("https://hr.hava.bz/trips/c9.jpg")
                .setDuration(109)
                .setDurationUnit("min")
                .setDistance(15.51f)
                .setDistanceUnit("km")
        ...
        trips.add(new Trip.Builder(3L)
                ...
                .setDriverRating(0)
                .setDriverPic("https://hr.hava.bz/trips/p11.jpg")
                .setCarMake("Toyota")
                .setCarModel("Rav4")
