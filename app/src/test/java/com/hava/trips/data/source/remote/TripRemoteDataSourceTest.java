...
import com.hava.trips.fakes.FakeTripService;
...
public class TripRemoteDataSourceTest {

    private TripRemoteDataSource dataSource;
    ...
    public void setUp() {
        ...
        dataSource = new TripRemoteDataSource(tripService);
    }
    ...
    private void populateData(Trip... trips) {
        ((FakeTripService) tripService).setTripRemote(new TripRemote(Arrays.asList(trips)));
    }
